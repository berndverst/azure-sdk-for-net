...
namespace Azure.ResourceManager.DurableTask.Models
{
    ...
    public partial class SchedulerSkuUpdate
    {
        ...
        internal SchedulerSkuUpdate(SchedulerSkuName? name, int? capacity, SchedulerRedundancyState? redundancyState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Capacity = capacity;
        ...
        public SchedulerRedundancyState? RedundancyState { get; }
    }
}
